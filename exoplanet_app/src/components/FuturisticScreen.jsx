...
import ExoplanetQuiz from "./Quiz"; // Import the Quiz component
  ...
  const FloatingWindow = () => {
    ...
    return (
      <div style={styles.floatingWindow} onClick={(e) => e.stopPropagation()}>
        ...
        <button onClick={() => (window.location.href = "/planet")}>
          Go to {exoplanetToTravel[selectedExoplanet]}
        </button>
      </div>
    );
  };
  ...
  return (
    <Html position={[1.2, 1, 2.8876587670825806]} transformScale={0.1}>
      <div style={styles.screenContainer}>
        ...
        {quizOpen && (
          <ExoplanetQuiz onClose={toggleQuiz} questions={questions} />
        )}
